...
<?php $__env->startSection('content'); ?>
    <div class="row justify-content-center">
        <div class="col-md-8">
            <p class="text-center">Notre roulotte, situé a Saint-Vivien de Blaye et à 35 minutes de Bordeaux, dispose de tout le confort nécessaire pour vous permettre de passer d'agreable
...
rgba(69,123,157,0.8);">
                    ...
                    <div class="carousel-item">
                        <img class="d-block w-100 h-100" src="/storage/<?php echo e($slider->hash); ?>"
                             alt="Second slide" style="transform: translateY(-20%);">
                        <?php if($slider->description): ?>
                            <div class="wrap-text" style="width: 100%;
position: absolute;
display: block;
...
rgba(69,123,157,0.8);">
            ...
            <p>Voici quelques informations à connaitre pour le bon déroulement de votre séjour.</p>
            ...
            <div class="col-md-6">
             ...
             <div class="col-md-6">
                 <h5>Equipements</h5>
                 <li>Literie de qualité hotelière</li>
                 <li>Douche et WC</li>
