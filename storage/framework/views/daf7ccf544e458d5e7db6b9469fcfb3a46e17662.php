...
<?php $__env->startSection('breadcrumbs'); ?>
    <?php echo e(\DaveJamesMiller\Breadcrumbs\Facades\Breadcrumbs::render('manage_roulotte')); ?>
    ...
    <div class="tab-pane fade <?php echo e($active); ?>" id="home" role="tabpanel" aria-labelledby="home-tab">
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><img src="/storage/<?php echo e($site->hash); ?>" style="max-width: 175px;"></td>
                        <td><?php echo e($site->description); ?></td>
                        <td><a href="<?php echo e(route('edit_roulotte',['id'=>$site->id])); ?>"><i class="fas fa-edit"></i></a> <a href="<?php echo e(route('delete_roulotte',['id'=>$site->id])); ?>"><i class="fas fa-trash"></i> </a> </td>
                    </tr>
        ...
        <div class="tab-pane fade <?php echo e($active1); ?>" id="profile" role="tabpanel" aria-labelledby="profile-tab">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="image" class="form-control-file form-control col-md-6 <?php if($active1): ?> <?php $__errorArgs = ['image'];
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alpha02/Location/resources/views/admin/roulotte/index.blade.php ENDPATH**/ ?>